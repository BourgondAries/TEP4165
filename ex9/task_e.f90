program simple
	...
	double precision :: a, b, q, tn = 400., ts = 350., te = 250., tw = 350., oldnorm, newnorm
	integer :: n, o, i, j, k
	...
	coeff(2,3:o) = -(a+2.*b)            ! Left
	coeff(n+1,3:o) = -(a+2.*b)          ! Right
	coeff(3:n,2) = -(2.*a+b)            ! Bottom
	coeff(3:n,o+1) = -(2.*a+3./2.*b)    ! Top

	coeff(3:n,3:o) = -2.*q              ! Internal nodes
	coeff(2,2) = -q                     ! Bottom left
	coeff(n+1,2) = -q                   ! Bottom right
	coeff(2,o+1) = -(a+3./2.*b)         ! Top left
	coeff(n+1,o+1) = -(a+3./2.*b)       ! Top right

	h(1,2:o+1) = 0.                       ! West
	h(2:n+1,1) = 0.                       ! South
	h(n+2,2:o+1) = -1250.*dx              ! East
	...
	open(10,file='e.dat',status='unknown')
