...
!---Convective heat transfer coefficient:
		write(*,*) 'Set the value of the convective heat transfer coefficient:'
		read(*,*) h
		write(*,*) 'Here is the number:',h
...
!---- Solving from left to right
		do i=istart+1,iend-1
			phi(i)=(aE(i)*phi(i+1)+aW(i)*phi(i-1))/aP(i)
		end do
